    ...
    <c:when test="${not empty products}">
        <main class="container">
            ...
            <div class="filter-sort__list-filter d-flex p-2">
                ...
                <a class="btn d-flex ${sort.equalsIgnoreCase("ASC") ? "bg-warning " : ""}" href="./home?sort=ASC&search1=${search}" style="background-color: #f0efef; margin-right: 10px;">
                    <div class="icon">
                ...
                <a class="btn d-flex ${sort.equalsIgnoreCase("DESC") ? "bg-warning " : ""}" href="./home?sort=DESC&search1=${search}" style="background-color: #f0efef;">
                    <div class="icon">
                        <svg height="15" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                            <path
