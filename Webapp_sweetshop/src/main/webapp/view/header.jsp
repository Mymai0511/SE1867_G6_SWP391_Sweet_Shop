    ...
    <div class="first-header d-flex justify-content-between align-items-center"
        ...
        <div class="d-flex align-items-center">
            <div class="login-or-logout d-flex justify-content-center align-items-center p-3">
                ...
                <a class="text-decoration-none" style="margin-right: 16px;" href="cart.jsp"><i
                        class="fa fa-shopping-cart"></i> Cart</a>
                <a class="text-decoration-none" style="margin-right: 16px;" href="/login"><i class="fa fa-lock"></i>
                    Login</a>
            </div>
        </div>
    </div>
