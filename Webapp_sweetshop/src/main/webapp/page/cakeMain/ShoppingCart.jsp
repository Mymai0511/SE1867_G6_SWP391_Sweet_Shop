<%-- 
    ...
    Created on : Sep 20, 2024, 3:20:56 PM
    Author     : hoang
--%>
...
<html>
    <head>
        ...
        <title>Shopping Cart | SweetShop</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                                ...
                                <c:forEach var="item" items="${cartItems}">
                                    <tr>
                                        ...
                                        <td class="quantity__item">
                                            <button style="background-color: #B8B8B8; border-radius: 15px;" onclick="updateQuantity(${item.productId}, -1)">-</button>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <a href="Index.jsp" class="primary-btn" style="border-radius: 20px; box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1);">
                                    Continue shopping
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="cart__summary" style="justify-content: flex-start;
                            ...
                            <ul>
                                <c:forEach var="item" items="${cartItems}">
                                    <li>${item.productName} <span>${item.productPrice}</span></li>
                                    </c:forEach>
                            </ul>
                            ...
                            <a href="bill.jsp" class="primary-btn" style="border-radius: 15px;
                               box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1);">CHECK OUT</a>
                        </div>
                    </div>
                </div>
            </div>
