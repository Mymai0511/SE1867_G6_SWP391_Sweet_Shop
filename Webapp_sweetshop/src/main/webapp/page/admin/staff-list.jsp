    ...
    <div class="iq-sidebar  sidebar-default ">
        <div class="iq-sidebar-logo d-flex align-items-center">
            <a href="../backend/index.html" class="header-logo">
                ...
                <h3 class="logo-title light-logo">Lazy Cake</h3>
            </a>
                ...
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li class="">
                        <a href="../app/user-list.html" class="svg-icon">
                            ...
                            <span class="ml-4">Manager User</span>
                        </a>
                    </li>
                    <li class="">
                        <a href="../backend/page-task.html" class="svg-icon">
                            ...
                            <span class="ml-4">Manager Product</span>
                        </a>
                    </li>
                    <li class="">
                        <a href="../backend/page-project.html" class="svg-icon">
                            ...
                            <span class="ml-4">Manager Order</span>
                        </a>
                    </li>
                    <li class="">
    ...
    <div class="iq-navbar-custom">
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                ...
                <a href="../backend/index.html" class="header-logo">
                    <h4 class="logo-title text-uppercase">Lazy Cake</h4>
                    ...
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                        ...
                                        <div class="px-3 pt-0 pb-0 sub-card">
                                                ...
                                                <div class="media align-items-center cust-card py-3 border-bottom">
                                                    <div class="">
                                                        <img class="avatar-50 rounded-small"
                                                             src="../../assets/image/user/01.jpg" alt="01">
                                                    </div>
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="media align-items-center cust-card py-3 border-bottom">
                                                    <div class="">
                                                        <img class="avatar-50 rounded-small"
                                                             src="../../assets/image/user/02.jpg" alt="02">
                                                    </div>
                                                    <div class="media-body ml-3">
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="media align-items-center cust-card py-3">
                                                    <div class="">
                                                        <img class="avatar-50 rounded-small"
                                                             src="../../assets/image/user/03.jpg" alt="03">
                                                    </div>
                                                    <div class="media-body ml-3">
                                                        <div class="d-flex align-items-center justify-content-between">
                        ...
                        <li class="nav-item nav-icon dropdown caption-content">
                            <a href="#" class="search-toggle dropdown-toggle  d-flex align-items-center" id="dropdownMenuButton4"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="../../assets/image/user/1.jpg" class="img-fluid rounded-circle" alt="user">
